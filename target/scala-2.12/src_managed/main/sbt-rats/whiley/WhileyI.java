...
public final class WhileyI extends ParserBase {
  ...
  private Result pStm$$Star5$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Vector<WhereExpr> v$10 = yyResult.semanticValue();
  ...
  private Result pStm$$Star6$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Vector<WhereExpr> v$12 = yyResult.semanticValue();

        yyValue = SVector.create(v$el$11, v$12);
  ...
  private Result pStm$$Star7$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Vector<WhereExpr> v$14 = yyResult.semanticValue();

        yyValue = SVector.create(v$el$13, v$14);
  ...
  private Result pStm$$Star8$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Vector<ElseIf> v$16 = yyResult.semanticValue();

        yyValue = SVector.create(v$el$15, v$16);
  ...
  private Result pStm$$Star9$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Vector<WhereExpr> v$19 = yyResult.semanticValue();

        yyValue = SVector.create(v$el$18, v$19);
  ...
  private Result pStm$$Star10$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Vector<RequiresEnsures> v$23 = yyResult.semanticValue();
  ...
  private Result pStm$$Star11$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Vector<RequiresEnsures> v$27 = yyResult.semanticValue();

        yyValue = SVector.create(v$el$26, v$27);
  ...
  private Result pStm$$Star12$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Vector<CommExp> v$29 = yyResult.semanticValue();

        yyValue = SVector.create(v$el$28, v$29);
