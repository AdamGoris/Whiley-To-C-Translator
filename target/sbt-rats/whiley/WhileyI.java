...
// on Saturday, 24 August 2019 at 10:22:14 AM.
...
public final class WhileyI extends ParserBase {
  ...
  private Result pStm$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("function")) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue("(")) {
          ...
          yyResult = pParameter(yyOption1);
          yyError  = yyResult.select(yyError, yyOption1);
          if (yyResult.hasValue()) {
            Parameter v$el$2 = yyResult.semanticValue();

            yyOption1  = yyResult.index;
            yyOpValue1 = v$el$2;
          }
          { // Start scope for v2.
            Parameter v2 = cast(yyOpValue1);
            ...
            if (yyResult.hasValue(")")) {
              ...
              yyError  = yyResult.select(yyError, yyOption1);
              if (yyResult.hasValue()) {
                ReturnType v$el$3 = yyResult.semanticValue();
              ...
              { // Start scope for v3.
                ...
                if (yyResult.hasValue(":")) {
                  ...
                  yyError  = yyResult.select(yyError);
                  if (yyResult.hasValue()) {
                    Stm v4 = yyResult.semanticValue();

                    yyValue = new FnDecl (v1, Option.apply (v2), Option.apply (v3), v4);
    ...
    if (yyResult.hasValue("return")) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Pair<CommLoc> v2 = yyResult.semanticValue();
  ...
  private Result pStm$$Star1$1(final int yyStart) throws IOException {
    Result        yyResult;
    Pair<CommLoc> yyValue;
    ParseError    yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pCommLoc(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      CommLoc v$el$4 = yyResult.semanticValue();

      yyResult = pStm$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<CommLoc> v$5 = yyResult.semanticValue();

        yyValue = new Pair<CommLoc>(v$el$4, v$5);
  ...
  /**
   * Parse nonterminal whiley.WhileyI.Parameter.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  public Result pParameter(final int yyStart) throws IOException {
    WhileyIColumn yyColumn = (WhileyIColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fParameter) 
      yyColumn.chunk1.fParameter = pParameter$1(yyStart);
    return yyColumn.chunk1.fParameter;
  }

  /** Actually parse whiley.WhileyI.Parameter. */
  private Result pParameter$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pParameter$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal whiley.WhileyI.Parameter$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pParameter$$Star1(final int yyStart) throws IOException {
    WhileyIColumn yyColumn = (WhileyIColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fParameter$$Star1) 
      yyColumn.chunk1.fParameter$$Star1 = pParameter$$Star1$1(yyStart);
    return yyColumn.chunk1.fParameter$$Star1;
  }

  /** Actually parse whiley.WhileyI.Parameter$$Star1. */
  private Result pParameter$$Star1$1(final int yyStart) throws IOException {
    Result            yyResult;
  ...
  public Result pReturnType(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("->")) {
      ...
      if (yyResult.hasValue("(")) {
        ...
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Parameter v1 = yyResult.semanticValue();
  ...
  public Result pTypeLoc(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk2.fTypeLoc) 
      yyColumn.chunk2.fTypeLoc = pTypeLoc$1(yyStart);
    return yyColumn.chunk2.fTypeLoc;
  }
  ...
  */
  ...
  static {
    add (KEYWORDS, new String[] {
      "bool", "byte", "else", "false", "function", "if", "int", "return",
      "true", "while"
    });
  }
