...
// on Monday, 19 August 2019 at 8:32:54 PM.
...
public final class WhileyI extends ParserBase {
  ...
  public Result pExpLevel2(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      while (true) {
        ...
        yyResult = pExpLevel2Tail(yyRepetition1);
        yyError  = yyResult.select(yyError, yyRepetition1);
        if (yyResult.hasValue()) {
  ...
  public Result pExpLevel1(final int yyStart) throws IOException {
    WhileyIColumn yyColumn = (WhileyIColumn)column(yyStart);
    if (null == yyColumn.fExpLevel1) 
      yyColumn.fExpLevel1 = pExpLevel1$1(yyStart);
    return yyColumn.fExpLevel1;
  }
  ...
  private Result pExpLevel1$$Star1(final int yyStart) throws IOException {
    WhileyIColumn yyColumn = (WhileyIColumn)column(yyStart);
    if (null == yyColumn.fExpLevel1$$Star1) 
      yyColumn.fExpLevel1$$Star1 = pExpLevel1$$Star1$1(yyStart);
    return yyColumn.fExpLevel1$$Star1;
  }
  ...
  public Result pExpLevel0(final int yyStart) throws IOException {
    WhileyIColumn yyColumn = (WhileyIColumn)column(yyStart);
    if (null == yyColumn.fExpLevel0) 
      yyColumn.fExpLevel0 = pExpLevel0$1(yyStart);
    return yyColumn.fExpLevel0;
  }
