...
// on Wednesday, 28 August 2019 at 12:23:58 PM.
...
public final class WhileyI extends ParserBase {
    ...
    if (yyResult.hasValue("type")) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue("is")) {
          ...
          yyResult = pFnType(yyChoice1);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            FnType v2 = yyResult.semanticValue();
            ...
            if (yyResult.hasValue()) {
              ...
              yyValue = new TypeDeclFn (v1, v2, v3);
            ...
            if (yyResult.hasValue(":")) {
              ...
              if (yyResult.hasValue()) {
                ...
                if (yyResult.hasValue()) {
                  ...
                  if (yyResult.hasValue()) {
                    Else v$el$17 = yyResult.semanticValue();
          ...
          { // Start scope for v2.
            ...
            if (yyResult.hasValue(")")) {
              ...
              { // Start scope for v3.
                ...
                yyResult = pStm$$Star10(yyOption1);
                yyError  = yyResult.select(yyError);
                if (yyResult.hasValue()) {
    ...
    if (yyResult.hasValue("method")) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue("(")) {
          ...
          yyError  = yyResult.select(yyError, yyOption1);
          if (yyResult.hasValue()) {
            Parameters v$el$24 = yyResult.semanticValue();
          ...
          { // Start scope for v2.
            ...
            if (yyResult.hasValue(")")) {
              ...
              yyError  = yyResult.select(yyError, yyOption1);
              if (yyResult.hasValue()) {
                ReturnType v$el$25 = yyResult.semanticValue();
              ...
              { // Start scope for v3.
                ...
                yyResult = pStm$$Star11(yyOption1);
                yyError  = yyResult.select(yyError);
                if (yyResult.hasValue()) {
                  Pair<RequiresEnsures> v4 = yyResult.semanticValue();
  ...
  private Result pStm$$Star5$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      WhereExpr v$el$9 = yyResult.semanticValue();

      yyResult = pStm$$Star5(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<WhereExpr> v$10 = yyResult.semanticValue();

        yyValue = new Pair<WhereExpr>(v$el$9, v$10);
  ...
  private Result pStm$$Star6$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      WhereExpr v$el$11 = yyResult.semanticValue();

      yyResult = pStm$$Star6(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<WhereExpr> v$12 = yyResult.semanticValue();

        yyValue = new Pair<WhereExpr>(v$el$11, v$12);
  ...
  private Result pStm$$Star7$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      WhereExpr v$el$13 = yyResult.semanticValue();

      yyResult = pStm$$Star7(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<WhereExpr> v$14 = yyResult.semanticValue();

        yyValue = new Pair<WhereExpr>(v$el$13, v$14);
  ...
  private Result pStm$$Star8$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      ElseIf v$el$15 = yyResult.semanticValue();

      yyResult = pStm$$Star8(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<ElseIf> v$16 = yyResult.semanticValue();

        yyValue = new Pair<ElseIf>(v$el$15, v$16);
  ...
  private Result pStm$$Star9$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      WhereExpr v$el$18 = yyResult.semanticValue();

      yyResult = pStm$$Star9(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<WhereExpr> v$19 = yyResult.semanticValue();

        yyValue = new Pair<WhereExpr>(v$el$18, v$19);
  ...
  private Result pStm$$Star11$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      RequiresEnsures v$el$26 = yyResult.semanticValue();

      yyResult = pStm$$Star11(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<RequiresEnsures> v$27 = yyResult.semanticValue();

        yyValue = new Pair<RequiresEnsures>(v$el$26, v$27);
  ...
  private Result pStm$$Star12$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      CommExp v$el$28 = yyResult.semanticValue();

      yyResult = pStm$$Star12(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<CommExp> v$29 = yyResult.semanticValue();

        yyValue = new Pair<CommExp>(v$el$28, v$29);
  ...
  /**
   * Parse nonterminal whiley.WhileyI.FnType.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  public Result pFnType(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyBase;
    FnType     yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    // Done.
    yyError = yyError.select("fn type expected", yyStart);
    return yyError;
  }
  ...
  public Result pParameters(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk3.fParameters) 
      yyColumn.chunk3.fParameters = pParameters$1(yyStart);
    return yyColumn.chunk3.fParameters;
  }
  ...
  private Result pParameters$$Star1(final int yyStart) throws IOException {
    WhileyIColumn yyColumn = (WhileyIColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fParameters$$Star1) 
      yyColumn.chunk3.fParameters$$Star1 = pParameters$$Star1$1(yyStart);
    return yyColumn.chunk3.fParameters$$Star1;
  }
  ...
  public Result pReturnType(final int yyStart) throws IOException {
    WhileyIColumn yyColumn = (WhileyIColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fReturnType) 
      yyColumn.chunk3.fReturnType = pReturnType$1(yyStart);
    return yyColumn.chunk3.fReturnType;
  }
  ...
  private Result pExpLevel5$$Star1(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk4.fExpLevel5$$Star1) 
      yyColumn.chunk4.fExpLevel5$$Star1 = pExpLevel5$$Star1$1(yyStart);
    return yyColumn.chunk4.fExpLevel5$$Star1;
  }
  ...
  public Result pExpLevel1(final int yyStart) throws IOException {
    WhileyIColumn yyColumn = (WhileyIColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fExpLevel1) 
      yyColumn.chunk4.fExpLevel1 = pExpLevel1$1(yyStart);
    return yyColumn.chunk4.fExpLevel1;
  }
  ...
  */
  ...
  static {
    add (KEYWORDS, new String[] {
      ...
      "default", "do", "else", "ensures", "export", "fail", "false", "from",
      "function", "if", "import", "int", "is", "method", "native", "null",
      "package", "private", "public", "requires", "return", "skip", "switch",
      "true", "type", "where", "while"
    });
  }
