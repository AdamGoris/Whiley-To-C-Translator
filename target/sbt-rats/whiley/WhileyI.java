...
public final class WhileyI extends ParserBase {
  ...
  private Result pStm$$Star7$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<RequiresEnsures> v$17 = yyResult.semanticValue();

        yyValue = new Pair<RequiresEnsures>(v$el$16, v$17);
  ...
  private Result pStm$$Star8$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<RequiresEnsures> v$21 = yyResult.semanticValue();

        yyValue = new Pair<RequiresEnsures>(v$el$20, v$21);
  ...
  private Result pStm$$Star9$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<CommExp> v$23 = yyResult.semanticValue();

        yyValue = new Pair<CommExp>(v$el$22, v$23);
            ...
            if (yyResult.hasValue()) {
              ...
              while (true) {
                ...
                if (yyResult.hasValue()) {
                  ...
                  yyRepetition1 = yyResult.index;
                  yyRepValue1   = new Pair<WhereExpr>(v$el$1, yyRepValue1);
                  continue;
                }
                break;
              }
              { // Start scope for v3.
                Pair<WhereExpr> v3 = yyRepValue1.reverse();
            ...
            if (yyResult.hasValue()) {
              ...
              while (true) {
                ...
                if (yyResult.hasValue()) {
                  ...
                  yyRepetition1 = yyResult.index;
                  yyRepValue1   = new Pair<WhereExpr>(v$el$2, yyRepValue1);
                  continue;
                }
                break;
              }
          ...
          if (yyResult.hasValue()) {
            ...
            while (true) {
              ...
              if (yyResult.hasValue()) {
                ...
                yyRepetition1 = yyResult.index;
                yyRepValue1   = new Pair<WhereExpr>(v$el$3, yyRepValue1);
                continue;
              }
              break;
            }
      ...
      if (yyResult.hasValue("(")) {
        ...
        while (true) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyRepetition1 = yyResult.index;
            yyRepValue1   = new Pair<TypeLoc>(v$el$1, yyRepValue1);
            continue;
          }
          break;
        }
        { // Start scope for v1.
          Pair<TypeLoc> v1 = yyRepValue1.reverse();
