...
// on Tuesday, 20 August 2019 at 1:12:11 PM.
...
public final class WhileyI extends ParserBase {
  ...
  private Result pExpLevel2$$Star1(final int yyStart) throws IOException {
    WhileyIColumn yyColumn = (WhileyIColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fExpLevel2$$Star1) 
      yyColumn.chunk1.fExpLevel2$$Star1 = pExpLevel2$$Star1$1(yyStart);
    return yyColumn.chunk1.fExpLevel2$$Star1;
  }
