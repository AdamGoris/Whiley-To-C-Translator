...
public final class CI extends ParserBase {
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue(")")) {
            ...
            if (yyResult.hasValue("{")) {
              ...
              yyError  = yyResult.select(yyError);
              if (yyResult.hasValue()) {
                Pair<CaseStmC> v2 = yyResult.semanticValue();
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue(")")) {
              ...
              if (yyResult.hasValue("{")) {
                ...
                yyError  = yyResult.select(yyError);
                if (yyResult.hasValue()) {
                  Pair<Stm> v4 = yyResult.semanticValue();
  ...
  private Result pStm$$Star1$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Stm> v$2 = yyResult.semanticValue();

        yyValue = new Pair<Stm>(v$el$1, v$2);
  ...
  private Result pStm$$Star2$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<CaseStmC> v$4 = yyResult.semanticValue();

        yyValue = new Pair<CaseStmC>(v$el$3, v$4);
  ...
  private Result pStm$$Star3$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Stm> v$6 = yyResult.semanticValue();

        yyValue = new Pair<Stm>(v$el$5, v$6);
  ...
  private Result pStm$$Star4$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Stm> v$8 = yyResult.semanticValue();

        yyValue = new Pair<Stm>(v$el$7, v$8);
  ...
  private Result pStm$$Star5$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Stm> v$10 = yyResult.semanticValue();

        yyValue = new Pair<Stm>(v$el$9, v$10);
      ...
      if (yyResult.hasValue()) {
        ...
        while (true) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyRepetition1 = yyResult.index;
            yyRepValue1   = new Pair<CommTypeLoc>(v$el$1, yyRepValue1);
            continue;
          }
          break;
        }
        { // Start scope for v3.
          Pair<CommTypeLoc> v3 = yyRepValue1.reverse();
